...
enum parameters {ELEMENT_LENGTH,CONST_TAU, CONST_KAPPA, CONST_LAMBDA, CONST_NY, CONST_PSI,CONST_ALPHA, CONST_DELTHA, CONST_ETA };
...
class mesh{
    ...
    public:
        void setParameters(float l,float tau,float kappa,float lambda,float ny, float psi, float alpha, float delta, float eta){
            parameters[ELEMENT_LENGTH]=l;
            parameters[CONST_TAU]= tau;
            parameters[CONST_KAPPA]= kappa;
            parameters[CONST_LAMBDA]=lambda;
            parameters[CONST_NY]= ny;
